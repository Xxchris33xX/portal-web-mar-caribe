...
<body>
  ...
  <section class="home-section">
    ...
    <section id="Consultar-Producto">
      <div class="menu-section">
        <span class="current-section"><label for="btn-modal">Historial de sesiones </label></span>
      </div>
              ...
              <div class="tile">
                <div class="tile-body">
                  <div class="table-responsive">
                    <table class="table display responsive nowrap" id="tableSesions">
                      <thead>
                        <tr>
                        <th>Código</th>
                        <th>Usuario</th>
  ...
  <script src="<?= PATH_ASSETS.'table/tableSes.js'?>"></script>
  <script>
