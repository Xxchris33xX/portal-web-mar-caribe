...
document.addEventListener('DOMContentLoaded',function(){
    tableSesions = new DataTable( "#tableSesions" , {
        "aProcessing":true,
        "aServerSide":true,
        /*"language": {
        ...
        "ajax":{
            "url" : host+path+"/con_ses/JSON/JSON",
            "dataSrc" : ""
        },
        "columns":[
            {"data":"id_sesion"},
        ...
        "columnDefs": [
            ...
            { type:'natural' ,targets: 0, "data":"id_historial", "render": function(data){return '<span>SSN - ' +data+'</span>'}},
            { type:'natural-ci' ,targets: 3},
            { targets: 2, "render": function(){return '<span>Inició Sesión</span>'}}
        ],
        "resonsieve":"true",
        "bDestroy": true,
        "iDisplayLength": 10,
            ...
            },
            {
                ...
                customize: function(doc) {
                   doc.content.splice( 0, 1, {
                    ...
                    let rowCount = tableSesions.rows.length;
                    for (i = 0; i < rowCount; i++) {
                        doc.content[2].table.body[i][2].alignment = 'right';
                    };
                    doc.defaultStyle.alignment = 'center';
                  },
                "messageTop": 'Historial de Sesiones'
            }
        ]
    })
},false);
